import { postUserExercise, getExercise, getOwnedExercisesTable, getAllExercisesTable, updateExercise, deleteExercise, getUserExercises } from "@/controllers/exercise/controller";
